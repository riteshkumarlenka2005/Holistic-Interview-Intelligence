/**
 * Server-side API endpoint for AI Chatbot
 * Uses OpenRouter API (same as question generation) for reliable responses
 */
...
// System prompt to keep the chatbot focused on interview topics
...
export const POST: APIRoute = async ({ request }) => {
    try {
        ...
        const conversationHistory: Message[] = body.history || [];
