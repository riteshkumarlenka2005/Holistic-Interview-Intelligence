...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_API_URL": "http://localhost:8000/v1", "PUBLIC_GEMINI_API_KEY": "", "SITE": undefined, "SSR": true};
